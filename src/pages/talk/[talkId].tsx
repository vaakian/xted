...
const TalkPage: NextPage = () => {
  ...
  if (!talkId) {
    return (
      <h1 className="flex flex-col h-screen w-screen items-center justify-center text-center text-4xl text-gray-700">
...
function Loading() {
  ...
  return (
    ...
    >
      <h1 className="mb-8 text-4xl text-gray-600">
        your transcript is on the way...
      </h1>
      <svg
        className="mr-2 inline h-[20vh] w-[20vw] animate-spin fill-red-600 text-gray-200 dark:text-gray-600"
        viewBox="0 0 100 101"
        fill="none"
